module.exports = {
  ...
  'btn-default-bg': '#37373F', // 默认按钮的背景颜色
  'btn-default-border': '#37373F', // 默认按钮的边框
  ...
  'table-bg': '#1B1B23',// table背景颜色
  'table-header-bg': '#24242D', // 表头颜色
  'table-body-sort-bg': 'fade(@white, 1%)',
  'table-row-hover-bg': '#33343C', // 鼠标hover行背景
  ...
  'switch-bg': '@white',
  'pagination-item-bg': 'transparent', // 常规状态下的页码的背景
  'pagination-item-bg-active': '#5B7EE2', // 激活页码的背景颜色
  'pagination-item-link-bg': 'transparent', // 上一页和下一页按钮的背景颜色
  ...
  'tabs-horizontal-padding': '16px 12px',  // 普通tabs头部的padding
  'tabs-ink-bar-color': '#FFF',  // tabs滑块颜色
  'tabs-highlight-color': '#FFF', // 选中tab的字体颜色
  'tabs-hover-color': '#FFF',
  'tabs-active-color': '#FFF',
  'charts-icon-hover-color': '#5B7EE2',
  'charts-icon-active-color': '#5B7EE2',
  'quota-chart-item-bg': '#171721',
  'quota-chart-item-head': '#808388',
  'quota-chart-item-text': '#fff',
};
